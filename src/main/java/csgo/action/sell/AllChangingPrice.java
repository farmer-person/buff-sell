...
public class AllChangingPrice implements Runnable {
    ...
    private void main ()
        ...
        JsonArray jsonArrayInventory = csgo.User.steamInventory (buff.Global.stringCookie,
                                                                 null);
        Thread.sleep (2000L);
    ...
    private void analysis (JsonObject jsonObjectItem)
        ...
        JsonArray jsonArraySell
            = csgo.Market.sellInformation (jsonObjectItem.get ("goods_id").getAsString (),
                                           null);
        Thread.sleep (1200L);
    ...
    private void changePrice ()
        ...
        for (int intX = intA; 0 <= intX; intX --) {
            ...
            stringData
                = new StringBuilder ().append ("{\"game\":\"csgo\",\"sell_orders\":[")
                                      .append (stringData)
                                      .append ("]}")
                                      .toString ();
            farmer.Http http
