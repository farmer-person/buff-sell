...
/**
<pre>
<a target="_blank" href="https://api.buff.163.com/api/market/buy_order/wait_supply?game=csgo&page_num=1&page_size=60">purchasing</a>
<a target="_blank" href="https://api.buff.163.com/market/buy_order/history?game=csgo&page_num=">buy log</a>
<a target="_blank" href="https://api.buff.163.com/api/market/backpack?game=csgo&page_num=1&page_size=60">buff backpack</a>
...
<a target="_blank" href="https://api.buff.163.com/api/market/sell_order/on_sale?game=csgo&mode=2%2C5&page_num=1&page_size=60">selling</a>
<a target="_blank" href="https://api.buff.163.com/api/market/steam_inventory?game=csgo&force=0&game=csgo&page_num=1&page_size=60&state=tradable">steam inventory</a>
...
public class User {
    ...
    */
    public static JsonArray buffBackpack (String stringCookie,
        ...
        try {
            String stringUrl
                = "https://api.buff.163.com/api/market/backpack?game=csgo&page_size=50&page_num=1";
            farmer.Http http
                = new farmer.Http ()
    ...
    */
    public static JsonArray steamInventory (String stringCookie,
        ...
        try {
            ...
            String stringUrl
                = "https://api.buff.163.com/api/market/steam_inventory?game=csgo&force=1&page_size=50&state=tradable";
            stringUrl += "&_=";
