...
public class Global {
    ...
    public static String stringUserId = null;
    ...
    static {
        try {
            ...
            if (! new java.io.File (stringUserHome + stringSeparator + ".buff_sell").exists ()) {
                init ();
            }
            else {
                properties.load (new java.io.FileInputStream (stringUserHome + stringSeparator + ".buff_sell"));
            ...
            stringCookie = farmer.Io.read ("cookie.txt")
                                    .trim ();
        }
    ...
    private static boolean checkCookie () {
        ...
        try {
            ...
            System.out.flush ();
            stringUserId = jsonObject.getAsJsonObject ("data")
                                     .get ("id")
                                     .getAsString ();
        }
        catch (java.lang.Exception e) {
    ...
    private static void init () {
        ...
        farmer.Io.write (stringUserHome + stringSeparator + ".buff_sell", stringContent);
    }
}
