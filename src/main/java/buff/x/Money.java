...
public class Money {
    ...
    public static void main (String[] args)
        ...
        //
        String stringUrl = "http://soft.iceyee.cn:10002/activate?id=%s&secret=%s&soft=buff_sell";
        ...
        if (http.getStringResponseBody ().contains ("true")) {
            ...
            properties.store (new java.io.FileOutputStream (stringUserHome + stringSeparator + ".buff_sell"),
                              "buff_sell");
        }
        else {
